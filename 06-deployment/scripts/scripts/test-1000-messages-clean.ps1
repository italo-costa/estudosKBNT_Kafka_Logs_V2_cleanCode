# TESTE REAL - 1000 MENSAGENS KAFKA COM INFRAESTRUTURA COMPLETA
param(
...
Write-Host "TESTE REAL - 1000 MENSAGENS KAFKA" -ForegroundColor Cyan
...
function Execute-MessageTest {
    Write-Header "EXECUTANDO TESTE DE 1000 MENSAGENS"
    ...
    for ($i = 1; $i -le $MessageCount; $i++) {
        ...
        if ($i % 100 -eq 0) {
            ...
            if ($i -eq 200 -or $i -eq 500 -or $i -eq 800) {
    ...
    Write-Success "Teste de 1000 mensagens CONCLUIDO!"
...
function Show-TestResults {
    ...
    $reportFile = "dashboard\data\teste-1000-msg-$(Get-Date -Format 'yyyyMMdd-HHmmss').json"
    
    $report = @{
        TestInfo = @{
            Type = "Real1000MessageTest"
...
try {
    ...
    # Phase 2: Execute 1000 message test
    ...
    Write-Header "TESTE DE 1000 MENSAGENS FINALIZADO"
...
Write-Host "TESTE REAL DE 1000 MENSAGENS KAFKA CONCLUIDO" -ForegroundColor Cyan
Write-Host "===============================================" -ForegroundColor Cyan
