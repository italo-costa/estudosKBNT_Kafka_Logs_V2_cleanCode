...
/**
 * Performance Tests for Kafka Publication Logging System
 * Tests hash generation, publication logging, and topic routing under high load
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("Kafka Publication Performance Tests")
