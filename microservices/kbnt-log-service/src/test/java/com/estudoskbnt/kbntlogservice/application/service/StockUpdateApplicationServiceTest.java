...
/**
 * Unit Tests for Stock Update Application Service
 * Tests the application layer's use case implementations
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("Stock Update Application Service Tests")
