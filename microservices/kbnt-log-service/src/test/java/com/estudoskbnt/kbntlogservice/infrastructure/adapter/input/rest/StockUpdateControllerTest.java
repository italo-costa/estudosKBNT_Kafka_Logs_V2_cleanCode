...
/**
 * Unit Tests for StockUpdateController (Hexagonal Architecture)
 * Tests REST API endpoints using the new hexagonal architecture
 */
@WebMvcTest(StockUpdateController.class)
@TestPropertySource(properties = {
    "app.processing.modes=producer"
})
@DisplayName("Stock Update Controller Tests (Hexagonal Architecture)")
