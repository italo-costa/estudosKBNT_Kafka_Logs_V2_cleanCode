...
/**
 * Performance Tests for StockUpdateController
 * Tests system behavior under high load with 100+ concurrent requests
 */
@WebMvcTest(StockUpdateController.class)
@DisplayName("StockUpdateController Performance Tests")
