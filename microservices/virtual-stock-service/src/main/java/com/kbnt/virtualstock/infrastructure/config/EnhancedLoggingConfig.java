package com.kbnt.virtualstock.infrastructure.config;
...
/**
 * Enhanced Logging Configuration for Virtual Stock Service
 * 
...
public class EnhancedLoggingConfig {
    ...
    private static final String SERVICE_COMPONENT = "VIRTUAL-STOCK";
    ...
    public void configureLogging() {
        ...
        fileAppender.setName("VIRTUAL-STOCK-FILE");
        fileAppender.setFile("logs/virtual-stock-service.log");
        ...
        rollingPolicy.setFileNamePattern("logs/virtual-stock-service.%d{yyyy-MM-dd}.%i.log");
    ...
    public static class LoggingUtils {
         ...
         * 
         * @param component Component identifier (VIRTUAL-STOCK, KAFKA_PRODUCER, etc.)
