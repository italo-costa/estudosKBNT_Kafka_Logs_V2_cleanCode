...
public interface StockManagementUseCase {
    ...
    interface StockReservationResult {
        ...
        static StockReservationResult success(Stock stock, StockUpdatedEvent event, Integer reservedQuantity) {
    ...
    class SuccessfulStockCreationResult implements StockCreationResult {
        ...
        @Override public Stock getStock() { return stock; }
        @Override public StockUpdatedEvent getEvent() { return event; }
    ...
    class FailedStockCreationResult implements StockCreationResult {
        ...
        @Override public Stock getStock() { return null; }
        @Override public StockUpdatedEvent getEvent() { return null; }
    ...
    class SuccessfulStockUpdateResult implements StockUpdateResult {
        ...
        @Override public boolean isSuccess() { return true; }
        @Override public Stock getUpdatedStock() { return stock; }
        @Override public StockUpdatedEvent getEvent() { return event; }
        @Override public String getErrorMessage() { return null; }
    }
    ...
    class FailedStockUpdateResult implements StockUpdateResult {
        ...
        @Override public boolean isSuccess() { return false; }
        @Override public Stock getUpdatedStock() { return null; }
        @Override public StockUpdatedEvent getEvent() { return null; }
        @Override public String getErrorMessage() { return errorMessage; }
    }
    ...
    class SuccessfulStockReservationResult implements StockReservationResult {
        ...
        public SuccessfulStockReservationResult(Stock stock, StockUpdatedEvent event, Integer reservedQuantity) {
            this.stock = stock;
            this.event = event;
        ...
        @Override public Stock getUpdatedStock() { return stock; }
        @Override public StockUpdatedEvent getEvent() { return event; }
        @Override public Integer getReservedQuantity() { return reservedQuantity; }
        @Override public String getErrorMessage() { return null; }
    }
    ...
    class FailedStockReservationResult implements StockReservationResult {
        ...
        @Override public Stock getUpdatedStock() { return null; }
        @Override public StockUpdatedEvent getEvent() { return null; }
        @Override public Integer getReservedQuantity() { return null; }
        @Override public String getErrorMessage() { return errorMessage; }
    }
}
